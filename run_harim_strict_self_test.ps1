...
$RunnerArgs = @{
    ...
    SelfTestMinAttachedGraspSampleCount = 1000
    SelfTestMaxAttachedGraspError = 0.23
    ...
    SelfTestMinInfeedFeedCartonCount = 1
    SelfTestMinInfeedFeedCartonObservedTravel = 0.10
    SelfTestMinInfeedFeedCartonStopClearance = 0.05
    SelfTestMinInfeedFeedCartonGuideClearance = 0.40
    SelfTestMaxInfeedFeedCartonBeltSupportGap = 0.02
    SelfTestMinActiveBinConveyorApproachCount = 8
    SelfTestMinActiveBinConveyorObservedTravel = 0.20
    SelfTestMaxActiveBinConveyorFinalError = 0.005
    SelfTestMaxActiveBinConveyorLateralError = 0.005
    ...
    SelfTestMaxAttachedBinFrameDisplacement = 0.08
    ...
    SelfTestMaxAmrOrientationError = 0.01
    ...
    SelfTestMinAmrLiftGuideCount = 4
    SelfTestMaxAmrLiftGuideBottomGap = 0.10
    SelfTestMinAmrLiftGuideTravelCover = 0.02
    SelfTestMaxAmrLiftGuidePoseError = 0.005
    SelfTestMaxAmrLiftOrientationError = 0.01
    ...
    SelfTestMaxDroppedStackOrientationError = 0.01
    SelfTestMaxDroppedStackSupportGap = 0.02
    SelfTestMinDroppedStackPalletMargin = 0.08
    SelfTestMinDroppedPalletPartCount = 18
    SelfTestMaxDroppedPalletPartPoseError = 0.005
    SelfTestMaxDroppedPalletPartOrientationError = 0.01
    ...
    SelfTestMaxPickupHandoffXyError = 0.03
    SelfTestMaxPickupHandoffLiftGap = 0.01
    SelfTestMaxPickupHandoffLiftPenetration = 0.005
    SelfTestMaxPickupEntryYError = 0.03
    SelfTestMinPickupEntryTunnelClearance = 0.10
    SelfTestMaxPickupEntryLiftGap = 0.01
    SelfTestMaxPickupEntryLiftPenetration = 0.005
    SelfTestMaxSlideOutYError = 0.03
    SelfTestMaxSlideOutLiftGap = 0.01
    SelfTestMaxSlideOutLiftPenetration = 0.005
    SelfTestMaxDropSupportGap = 0.01
    SelfTestMaxDropHandoffXyError = 0.03
    SelfTestMaxDropHandoffSupportGap = 0.01
    SelfTestMaxDropHandoffSupportPenetration = 0.005
    ...
    SelfTestMaxCarriedPayloadOrientationError = 0.01
