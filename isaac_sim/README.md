...
현재 검증 범위는 단일 사이클, 무한 반복 reset, 실제 `iw_hub` lift prim 연동, stage loading wait helper, extension/import 의존성, headless self-test loop입니다.
...
2026-05-29 기준 위 세 검증은 통과했습니다. headless 로그에서 `iw_hub/chassis/lift` prim 사용과 `self-test completed after 2 frames`를 확인했습니다.
