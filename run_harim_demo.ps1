param(
    ...
    [int]$SelfTestMinInfeedFeedCartonCount = 0,
    [double]$SelfTestMinInfeedFeedCartonObservedTravel = 0.0,
    [double]$SelfTestMinInfeedFeedCartonStopClearance = 0.0,
    [double]$SelfTestMinInfeedFeedCartonGuideClearance = 0.0,
    [double]$SelfTestMaxInfeedFeedCartonBeltSupportGap = 0.0,
    [int]$SelfTestMinSafetyFencePartCount = 0,
    [double]$SelfTestMinSafetyFenceAmrGateClearance = 0.0,
    [double]$SelfTestMinAmrCellGateClearance = 0.0,
    ...
    [int]$SelfTestMinAmrLiftGuideCount = 0,
    [double]$SelfTestMaxAmrLiftGuideBottomGap = 0.0,
    [double]$SelfTestMinAmrLiftGuideTravelCover = 0.0,
    [double]$SelfTestMaxAmrLiftGuidePoseError = 0.0,
    ...
    [double]$SelfTestMaxPickupEntryYError = 0.0,
    [double]$SelfTestMinPickupEntryTunnelClearance = 0.0,
    [double]$SelfTestMaxPickupEntryLiftGap = 0.0,
    [double]$SelfTestMaxPickupEntryLiftPenetration = 0.0,
...
$ArgsList = @(
    ...
    "--self-test-min-infeed-feed-carton-count", $SelfTestMinInfeedFeedCartonCount,
    "--self-test-min-infeed-feed-carton-observed-travel", $SelfTestMinInfeedFeedCartonObservedTravel,
    "--self-test-min-infeed-feed-carton-stop-clearance", $SelfTestMinInfeedFeedCartonStopClearance,
    "--self-test-min-infeed-feed-carton-guide-clearance", $SelfTestMinInfeedFeedCartonGuideClearance,
    "--self-test-max-infeed-feed-carton-belt-support-gap", $SelfTestMaxInfeedFeedCartonBeltSupportGap,
    ...
    "--self-test-min-amr-cell-gate-clearance", $SelfTestMinAmrCellGateClearance,
    ...
    "--self-test-min-amr-lift-guide-count", $SelfTestMinAmrLiftGuideCount,
    "--self-test-max-amr-lift-guide-bottom-gap", $SelfTestMaxAmrLiftGuideBottomGap,
    "--self-test-min-amr-lift-guide-travel-cover", $SelfTestMinAmrLiftGuideTravelCover,
    "--self-test-max-amr-lift-guide-pose-error", $SelfTestMaxAmrLiftGuidePoseError,
    ...
    "--self-test-max-pickup-entry-y-error", $SelfTestMaxPickupEntryYError,
    "--self-test-min-pickup-entry-tunnel-clearance", $SelfTestMinPickupEntryTunnelClearance,
    "--self-test-max-pickup-entry-lift-gap", $SelfTestMaxPickupEntryLiftGap,
    "--self-test-max-pickup-entry-lift-penetration", $SelfTestMaxPickupEntryLiftPenetration,
