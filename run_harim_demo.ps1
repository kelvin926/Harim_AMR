param(
    ...
    [int]$SelfTestMaxRejectedAttachCount = -1,
    [int]$SelfTestMaxReachPickTimedReleaseCount = -1,
    ...
    [int]$SelfTestMinAttachedGraspSampleCount = 0,
    [double]$SelfTestMaxAttachedGraspError = 0.0,
    ...
    [int]$SelfTestMinActiveBinConveyorApproachCount = 0,
    [double]$SelfTestMinActiveBinConveyorObservedTravel = 0.0,
    [double]$SelfTestMaxActiveBinConveyorFinalError = 0.0,
    [double]$SelfTestMaxActiveBinConveyorLateralError = 0.0,
    [double]$SelfTestMaxActiveBinConveyorBeltSupportGap = 0.0,
    [int]$SelfTestMinMotionContinuitySampleCount = 0,
    [double]$SelfTestMaxAmrFrameDisplacement = 0.0,
    [double]$SelfTestMaxArmEeFrameDisplacement = 0.0,
    [int]$SelfTestMaxMeasuredArmFkFallbacks = -1,
    [double]$SelfTestMaxActiveBinFrameDisplacement = 0.0,
    [double]$SelfTestMaxAttachedBinFrameDisplacement = 0.0,
    [double]$SelfTestMaxScriptedPlaceBinFrameDisplacement = 0.0,
    [double]$SelfTestMaxReleasedBinFrameDisplacement = 0.0,
    [double]$SelfTestMaxCarriedPayloadFrameDisplacement = 0.0,
    [double]$SelfTestMaxCarriedPalletFrameDisplacement = 0.0,
    ...
    [double]$SelfTestMaxAmrOrientationError = 0.0,
    ...
    [double]$SelfTestMaxAmrLiftOrientationError = 0.0,
    [double]$SelfTestMinPayloadLift = 0.0,
    [double]$SelfTestMaxLiftOffsetFrameStep = 0.0,
    ...
    [double]$SelfTestMaxDroppedStackOrientationError = 0.0,
    ...
    [double]$SelfTestMaxDroppedPalletPartOrientationError = 0.0,
    ...
    [double]$SelfTestMinArmTcpAmrRouteClearance = 0.0,
    [double]$SelfTestMaxCarriedPalletPoseError = 0.0,
    [double]$SelfTestMaxCarriedPalletOrientationError = 0.0,
    [double]$SelfTestMaxCarriedPayloadPoseError = 0.0,
    [double]$SelfTestMaxCarriedPayloadOrientationError = 0.0,
...
$ArgsList = @(
    ...
    "--self-test-max-rejected-attach-count", $SelfTestMaxRejectedAttachCount,
    "--self-test-max-reach-pick-timed-release-count", $SelfTestMaxReachPickTimedReleaseCount,
    ...
    "--self-test-min-attached-grasp-sample-count", $SelfTestMinAttachedGraspSampleCount,
    "--self-test-max-attached-grasp-error", $SelfTestMaxAttachedGraspError,
    ...
    "--self-test-min-active-bin-conveyor-approach-count", $SelfTestMinActiveBinConveyorApproachCount,
    "--self-test-min-active-bin-conveyor-observed-travel", $SelfTestMinActiveBinConveyorObservedTravel,
    "--self-test-max-active-bin-conveyor-final-error", $SelfTestMaxActiveBinConveyorFinalError,
    "--self-test-max-active-bin-conveyor-lateral-error", $SelfTestMaxActiveBinConveyorLateralError,
    "--self-test-max-active-bin-conveyor-belt-support-gap", $SelfTestMaxActiveBinConveyorBeltSupportGap,
    "--self-test-min-motion-continuity-sample-count", $SelfTestMinMotionContinuitySampleCount,
    "--self-test-max-amr-frame-displacement", $SelfTestMaxAmrFrameDisplacement,
    "--self-test-max-arm-ee-frame-displacement", $SelfTestMaxArmEeFrameDisplacement,
    "--self-test-max-measured-arm-fk-fallbacks", $SelfTestMaxMeasuredArmFkFallbacks,
    "--self-test-max-active-bin-frame-displacement", $SelfTestMaxActiveBinFrameDisplacement,
    "--self-test-max-attached-bin-frame-displacement", $SelfTestMaxAttachedBinFrameDisplacement,
    "--self-test-max-scripted-place-bin-frame-displacement", $SelfTestMaxScriptedPlaceBinFrameDisplacement,
    "--self-test-max-released-bin-frame-displacement", $SelfTestMaxReleasedBinFrameDisplacement,
    "--self-test-max-carried-payload-frame-displacement", $SelfTestMaxCarriedPayloadFrameDisplacement,
    "--self-test-max-carried-pallet-frame-displacement", $SelfTestMaxCarriedPalletFrameDisplacement,
    ...
    "--self-test-max-amr-orientation-error", $SelfTestMaxAmrOrientationError,
    ...
    "--self-test-max-amr-lift-orientation-error", $SelfTestMaxAmrLiftOrientationError,
    "--self-test-min-payload-lift", $SelfTestMinPayloadLift,
    "--self-test-max-lift-offset-frame-step", $SelfTestMaxLiftOffsetFrameStep,
    ...
    "--self-test-max-dropped-stack-orientation-error", $SelfTestMaxDroppedStackOrientationError,
    ...
    "--self-test-max-dropped-pallet-part-orientation-error", $SelfTestMaxDroppedPalletPartOrientationError,
    ...
    "--self-test-min-arm-tcp-amr-route-clearance", $SelfTestMinArmTcpAmrRouteClearance,
    "--self-test-max-carried-pallet-pose-error", $SelfTestMaxCarriedPalletPoseError,
    "--self-test-max-carried-pallet-orientation-error", $SelfTestMaxCarriedPalletOrientationError,
    "--self-test-max-carried-payload-pose-error", $SelfTestMaxCarriedPayloadPoseError,
    "--self-test-max-carried-payload-orientation-error", $SelfTestMaxCarriedPayloadOrientationError,
